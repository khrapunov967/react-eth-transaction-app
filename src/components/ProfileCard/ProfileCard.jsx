...
const ProfileCard = ({userAddress, userBalance}) => {
    return (
        <div className="flex w-full items-center border-solid border-2 p-2 gap-5 mb-5 rounded-lg border-slate-100 shadow-lg">
            ...
            <div className="flex flex-col">
                <div className="w-full flex gap-2 items-center">
                    ...
                    <p className="truncate text-lg">{userAddress}</p>
                </div>

                <div className={`w-full flex gap-2 items-center`}>
                    <p className="text-lg">Current Balance:</p>
                    <p className="text-green-400 text-lg truncate">{userBalance}</p>
                </div>
            </div>
        </div>
    );
